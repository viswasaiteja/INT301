<?php
	define("SITE_ADDR", "http://localhost/test/search_engine");
	include("./include.php");
...
<html>
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="top_header">
				<div id="nav">
					<a href="<?php echo SITE_ADDR;?>/new_entry.php">By Teja 11609704</a>
				</div>
			...
			<div id="footer">
				<div class="left">
					<a href="https://example:contentwriter communicationskills etc" target="_blank">For Example:java communicationskills etc.</a>
				</div>
				<div class="right">
